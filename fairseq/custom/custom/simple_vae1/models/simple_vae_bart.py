...
@register_model("simple_vae_bart")
class SimpleVaeBART(BARTModel):
    @staticmethod
    def add_args(parser):
    ...
    def build_model(cls, args, task):
        ...
        if pretrained:
            ...
            #     param.requires_grad = False
        model = SimpleVaeBART(args, trained_model)

        return model 
        


@register_model_architecture("simple_vae_bart", "simple_vae_bart_large")
def simple_vae_bart_large_architecture(args):
...
@register_model_architecture("simple_vae_bart","simple_vae_bart_base" )
def simple_vae_bart_base_architecture(args):
    ...
    simple_vae_bart_large_architecture(args)