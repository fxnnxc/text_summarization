...
def main(cfg: DictConfig) -> None:
    ...
    model = BART_VAE_LSTM(baseline_model=baseline_model, args=cfg.model)
    #model.half()
   ...
   #---------------------------------------------------------------------------------------------------
    ...
    logger.info("model: {}".format(baseline_model.__class__.__name__))
...
def train(
    ...
    writer = SummaryWriter(cfg.checkpoint_suffix)
    ...
    for i, samples in enumerate(progress):
        ...
        if log_output is not None:  # not OOM, overflow, ...
            ...
            writer.add_scalar("Loss/Kld",   log_output['kld_loss'], i)
