...
class VaeBART(BARTModel):
    ...
    def __init__(self, args, pretrained_bart):
        ...
        self.lstm_mu = nn.GRU(self.n,self.n//2, 2)  #input_dim x hidden x layer
    ...
    def build_model(cls, args, task):
        ...
        if pretrained:
            ...
            #     param.requires_grad = False
        model = VaeBART(args, trained_model)

        return model 
        


@register_model_architecture("vae_bart", "vae_bart_large")
def vae_bart_large_architecture(args):
...
@register_model_architecture("vae_bart","vae_bart_base" )
def vae_bart_base_architecture(args):
    ...
    vae_bart_large_architecture(args)